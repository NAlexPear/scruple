...
Candidates contain bounded local evidence with explicit completeness metadata. Re-exports, mounted
routers, class visibility, call graphs, global middleware, and behavior in unresolved helpers are
not inferred from a single file. Large functions and handlers over 12,000 characters are skipped.
These limits keep selection deterministic and make missing evidence an explicit
